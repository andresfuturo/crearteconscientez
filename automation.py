"""Módulo de automatización para registro de usuarios.

Este módulo contiene funciones para automatizar el proceso de registro de usuarios
en el sistema Crearte ConscienteZ.
"""
...
def iniciar_registro() -> None:
    """Inicia el proceso de registro automático.

    Esta función abre el navegador, navega a la página de registro,
    completa el formulario con datos de prueba y verifica el registro exitoso.
    """
